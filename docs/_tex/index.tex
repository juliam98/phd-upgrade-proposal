...
\phantomsection\label{cell-fig-lev_hc_vs_sz}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-lev_hc_vs_sz-1.pdf}
...
\phantomsection\label{cell-fig-gantt-chart}
\begin{figure}[H]

\centering{

\includegraphics{index_files/figure-pdf/fig-gantt-chart-1.pdf}
